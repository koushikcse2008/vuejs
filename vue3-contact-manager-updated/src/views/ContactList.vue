<template>
    ...
    <tbody className="bg-light">
        <tr v-for="contact in contacts" :key="contact.id">
            ...
            <td colSpan="3">
                <router-link :to="'/show-contact/'+ contact.id" className="btn btn-outline-success me-2"> View </router-link>
                <router-link :to="'/edit-contact/'+ contact.id +'/edit'" className="btn btn-outline-warning me-2"> Edit </router-link>
